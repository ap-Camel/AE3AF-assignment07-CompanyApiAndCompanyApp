...
namespace CompanyAppTask.Services
{
    class CompanyAppServices
    {
        ...
        private const string apiUrl = "http://192.168.137.1:5012/";
        ...
        public async Task<bool> AddItem<T>(string controller, T item) where T : new()
        {
            bool success = false;
        ...
        public async Task<bool> UpdateItem<T>(string controller, T item) where T : new()
        {
            bool success = false;
        ...
        public async Task<bool> DeleteItem(string controller)
        {
            bool success = false;
